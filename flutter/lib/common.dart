...
import 'package:flutter_hbb/itinalog/brand.dart'; // ITINALOG
...
class MyTheme {
  ...
  static const Color accent50 = Color(0x77E31E24);
  static const Color accent80 = Color(0xAAE31E24);
  static const Color canvasColor = Color(0xFF212121);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFFC4191F);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFE31E24);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(18.0) /* ITINALOG radius */,
        ),
      ),
    ),
    ...
    colorScheme: ColorScheme.light(
        primary: const Color(0xFFE31E24) /* ITINALOG */, secondary: accent, background: grayBg),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      primary: const Color(0xFFE31E24) /* ITINALOG */,
      secondary: accent,
